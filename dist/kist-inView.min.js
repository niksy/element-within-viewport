...
!function(a,b){function c(){return k.top=h.common.window.scrollTop(),k.bottom=k.top+h.common.window.height(),k}function d(a){var b=this.getElements(this.dom.el,this.options.threshold);return b.length?a.call(null,b):void 0}function e(b,c,d){return this.options.debounce&&a.debounce?a.debounce(b,a.proxy(c,this,d)):a.proxy(c,this,d)}function f(b,c,e){this.element=b,this.options=a.extend({},this.defaults,c),j.setup.call(this),h.setup.call(this),i.setup.call(this,e),d.call(this,e)}var g={name:"inView",ns:{css:"kist-InView",event:".kist.inView"}},h={common:{window:a(b)},setup:function(){this.dom=this.dom||{},this.dom.el=a(this.element)}},i={setup:function(a){h.common.window.on("scroll"+this.instance.ens+" resize"+this.instance.ens,e.call(this,this.options.debounce,d,a))},destroy:function(){h.common.window.off(this.instance.ens)}},j={id:0,setup:function(){this.instance=this.instance||{},this.instance.id=j.id++,this.instance.ens=g.ns.event+"."+this.instance.id},destroy:function(){this.dom.el.each(function(b,c){delete a.data(c)[g.name]})}},k={top:0,bottom:0};a.extend(f.prototype,{isVisible:function(a,b){var c=a.offset().top,d=c+a.height();return b=b||this.defaults.threshold,d>=k.top-b&&c<=k.bottom+b},getElements:function(b,d){return c(),b.filter(a.proxy(function(b,c){return this.isVisible(a(c),d)},this))},destroy:function(){j.destroy.call(this),i.destroy.call(this)},defaults:{threshold:0,debounce:300,success:null}}),a.kist=a.kist||{},a.kist[g.name]={defaults:f.prototype.defaults},a.fn[g.name]=function(b,c){return b=b||{},c=c||b.success,"number"==typeof b&&(b={threshold:b}),"string"==typeof b?this.each(function(){a.data(this,g.name)&&a.data(this,g.name)[b]()}):c?this.filter(function(b,c){return!a.data(c,g.name)}).data(g.name,new f(this,b,c)):f.prototype.getElements(this,b.threshold)}}(jQuery,window,document);